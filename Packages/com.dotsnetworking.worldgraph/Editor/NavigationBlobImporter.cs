...
namespace DotsNetworking.WorldGraph.Editor
{
    ...
    */
    ...
    public class NavigationBlobImporterEditor : ScriptedImporterEditor
    {
        ...
        BlobAssetReference<Region> blob;
        ...
        static MethodInfo TryReadInplace = typeof(BlobAssetReference<Region>).GetMethod("TryReadInplace", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
        public override void OnEnable()
        {
            ...
            MethodInfo TryReadInplace = typeof(BlobAssetReference<Region>).GetMethod("TryReadInplace", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
            unsafe
            {
                ...
                object[] parameters = new object[]
                {
                    ...
                    default(BlobAssetReference<Region>),  // result (out BlobAssetReference<T>)
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(blob.IsCreated)
            {
                //EditorGUILayout.LabelField($"Regions Count: {blob.Value.Chunks.Length}");
            }
            else
            {
