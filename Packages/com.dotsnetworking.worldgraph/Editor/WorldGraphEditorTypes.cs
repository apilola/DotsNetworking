...
namespace DotsNetworking.WorldGraph.Editor
{
    ...
    {
        public float[] Heights = new float[WorldGraphConstants.NodesPerChunk]; // NaN = invalid
        public MovementFlags[] Flags = new MovementFlags[WorldGraphConstants.NodesPerChunk];
