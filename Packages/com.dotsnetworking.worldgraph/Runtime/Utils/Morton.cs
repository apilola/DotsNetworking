...
namespace DotsNetworking.WorldGraph.Utils
{
    ...
    public static class Morton
    {
        ...
        /// <summary>
        /// Encode a 2 dimensional coordinate to morton code.
        /// </summary>
        /// <param name="coordinate">x,y coordinate</param>
        /// <returns>The morton code</returns>
        public static uint EncodeMorton2D(uint2 coordinate)
        {
             // For 2D, we only check fitting in roughly 16 bits half-width? 
             // Max 2D coordinate is 65535 (16 bits) -> 32 bits result.
             return (Part1By1_32(coordinate.y) << 1) + Part1By1_32(coordinate.x);
        }
        
        /// <summary>
        /// Decode a morton code to 2 dimensional coordinate.
        /// </summary>
        public static uint2 DecodeMorton2D(uint code)
        {
            return new uint2(Compact1By1_32(code), Compact1By1_32(code >> 1));
        }
