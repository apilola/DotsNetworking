namespace DotsNetworking.WorldGraph
{
    ...
    {
        public int MortonCode; //3D morton code of region within world
        ...
        // Size: ~64KB per region.
        public BlobArray<short> ChunkLookup;
    }

    public struct Chunk
    {
        public ushort MortonCode; // 15-bit Morton code (3D) within region
        public BlobArray<Node> Nodes; // Dense array (256 nodes), indexed by local Morton code

        // world origin of chunk can be extracted from region morton code + chunk morton code
    }
    ...
    public struct Node
    {
        ...
        // See MovementFlags in WorldGraphTypes.cs for layout
